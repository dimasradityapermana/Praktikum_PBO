...
public class tambahSupplier {
    ...
    public void tambahSupplier(Supplier supplier) {
        daftarSupplier.add(supplier);
        System.out.println("Supplier berhasil ditambahkan melalui objek!");
    }

    public void tambahSupplier(String nama, String alamat, String telepon) {
        Supplier supplier = new Supplier(supplierIdCounter++, nama, alamat, telepon);
        daftarSupplier.add(supplier);
        System.out.println("Supplier berhasil ditambahkan dengan parameter individual!");
    }
}